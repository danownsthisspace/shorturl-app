...
try{var G__33004_33084 = (function (p1__32997_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__32997_SHARP_);
});
var G__33005_33085 = (function (p1__32998_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__32998_SHARP_);
});
(f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__33004_33084,G__33005_33085) : f.call(null,G__33004_33084,G__33005_33085));
}catch (e33003){var e_33086 = e33003;
promesa.protocols._reject_BANG_(d,e_33086);
}
return d;
}));
...
try{var G__33007 = (function (p1__32999_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__32999_SHARP_);
});
var G__33008 = (function (p1__33000_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__33000_SHARP_);
});
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__33007,G__33008) : f.call(null,G__33007,G__33008));
}catch (e33006){var e = e33006;
...
var len__5769__auto___33102 = arguments.length;
var i__5770__auto___33103 = (0);
while(true){
if((i__5770__auto___33103 < len__5769__auto___33102)){
args_arr__5794__auto__.push((arguments[i__5770__auto___33103]));

var G__33104 = (i__5770__auto___33103 + (1));
i__5770__auto___33103 = G__33104;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__33020_SHARP_,p2__33021_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__33020_SHARP_,p2__33021_SHARP_);
}),p,cljs.core.cons(f,fs));
}));

/** @this {Function} */
(promesa.core.chain.cljs$lang$applyTo = (function (seq33023){
var G__33024 = cljs.core.first(seq33023);
var seq33023__$1 = cljs.core.next(seq33023);
var G__33025 = cljs.core.first(seq33023__$1);
var seq33023__$2 = cljs.core.next(seq33023__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33024,G__33025,seq33023__$2);
}));
...
default:
var args_arr__5794__auto__ = [];
var len__5769__auto___33111 = arguments.length;
var i__5770__auto___33112 = (0);
while(true){
if((i__5770__auto___33112 < len__5769__auto___33111)){
args_arr__5794__auto__.push((arguments[i__5770__auto___33112]));

var G__33113 = (i__5770__auto___33112 + (1));
i__5770__auto___33112 = G__33113;
continue;
} else {
}
break;
...
/** @this {Function} */
(promesa.core.chain_SINGLEQUOTE_.cljs$lang$applyTo = (function (seq33028){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33029,G__33030,seq33028__$2);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__33036_SHARP_){
return (p1__33036_SHARP_ instanceof pred_or_type);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__33039_SHARP_){
return (p1__33039_SHARP_ instanceof pred_or_type);
}));
...
var seq__33046 = cljs.core.seq(promises);
var chunk__33047 = null;
var count__33048 = (0);
var i__33049 = (0);
while(true){
if((i__33049 < count__33048)){
var p = chunk__33047.cljs$core$IIndexed$_nth$arity$2(null,i__33049);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__33046,chunk__33047,count__33048,i__33049,p,state){
return (function (v){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__33046,chunk__33047,count__33048,i__33049,p,state){
...
});})(seq__33046,chunk__33047,count__33048,i__33049,p,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__33046,chunk__33047,count__33048,i__33049,p,state))
),((function (seq__33046,chunk__33047,count__33048,i__33049,p,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__33046,chunk__33047,count__33048,i__33049,p,state){
return (function (state__$1){
...
var map__33054 = cljs.core.deref(state);
var map__33054__$1 = cljs.core.__destructure_map(map__33054);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33054__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33054__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33054__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
...
var G__33055 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__33055) : reject.call(null,G__33055));
} else {
...
var G__33123 = seq__33046;
var G__33124 = chunk__33047;
var G__33125 = count__33048;
var G__33126 = (i__33049 + (1));
seq__33046 = G__33123;
chunk__33047 = G__33124;
count__33048 = G__33125;
i__33049 = G__33126;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__33046);
if(temp__5720__auto__){
var seq__33046__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__33046__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__33046__$1);
var G__33127 = cljs.core.chunk_rest(seq__33046__$1);
var G__33128 = c__5568__auto__;
var G__33129 = cljs.core.count(c__5568__auto__);
var G__33130 = (0);
seq__33046 = G__33127;
chunk__33047 = G__33128;
count__33048 = G__33129;
i__33049 = G__33130;
continue;
} else {
var p = cljs.core.first(seq__33046__$1);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__33046,chunk__33047,count__33048,i__33049,p,seq__33046__$1,temp__5720__auto__,state){
return (function (v){
if(cljs.core.truth_(new cljs.core.Keyword(null,"resolved","resolved",968763567).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__33046,chunk__33047,count__33048,i__33049,p,seq__33046__$1,temp__5720__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567),true),new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec);
});})(seq__33046,chunk__33047,count__33048,i__33049,p,seq__33046__$1,temp__5720__auto__,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__33046,chunk__33047,count__33048,i__33049,p,seq__33046__$1,temp__5720__auto__,state))
),((function (seq__33046,chunk__33047,count__33048,i__33049,p,seq__33046__$1,temp__5720__auto__,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__33046,chunk__33047,count__33048,i__33049,p,seq__33046__$1,temp__5720__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec),new cljs.core.Keyword(null,"rejections","rejections",-1620899911),cljs.core.conj,e);
...
var map__33056 = cljs.core.deref(state);
var map__33056__$1 = cljs.core.__destructure_map(map__33056);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33056__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33056__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33056__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
if(((cljs.core.not(resolved)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(counter,(0))))){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(default$,new cljs.core.Keyword("promesa.core","default","promesa.core/default",1773193826))){
var G__33057 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__33057) : reject.call(null,G__33057));
} else {
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(default$) : resolve.call(null,default$));
}
} else {
...
var G__33131 = cljs.core.next(seq__33046__$1);
var G__33132 = null;
var G__33133 = (0);
var G__33134 = (0);
seq__33046 = G__33131;
chunk__33047 = G__33132;
count__33048 = G__33133;
i__33049 = G__33134;
continue;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__33058_SHARP_,p2__33059_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__33058_SHARP_,(function (_){
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p2__33059_SHARP_) : f.call(null,p2__33059_SHARP_));
}));
...
}catch (e33064){if((e33064 instanceof Error)){
var e = e33064;
