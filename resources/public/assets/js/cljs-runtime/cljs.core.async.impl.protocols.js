...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30589 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30589(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30595 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30595(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30597 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30597(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30601 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30601(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30602 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30602(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30606 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30606(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30610 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30610(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30611 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30611(b);
}
});
...
var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30619 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30619(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30630 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30630(b);
}
});
