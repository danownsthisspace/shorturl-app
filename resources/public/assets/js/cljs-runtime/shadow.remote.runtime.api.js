...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33142 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33142(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33143 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33143(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_33146 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_33146(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33148 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33148(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33149 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33149(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33151 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33151(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33131,callback){
var map__33133 = p__33131;
var map__33133__$1 = cljs.core.__destructure_map(map__33133);
var input = map__33133__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33133__$1,new cljs.core.Keyword(null,"code","code",1586293142));
